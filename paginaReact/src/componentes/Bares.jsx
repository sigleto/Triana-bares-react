...
<div className="contenido1">
    <div className="estab">  
    <div className="bar">LA PARRALA</div>
    <ul>
    ...
    <div className="estab">  
    <div className="bar">EL ALBOROQUE</div>
    <ul>
    ...
    <div className="estab">  
    <div className="bar">CASA DIEGO</div>
    <ul>
    ...
    <div className="estab">  
    <div className="bar">CASA RUPERTO</div>
    <ul>
        <li><a href="https://www.google.es/maps/place/Bar+Casa+Ruperto/@37.3819311,-6.0085324,15z/data=!4m6!3m5!1s0xd126c6963bc510d:0xc6d653b3474cfdfc!8m2!3d37.3819311!4d-6.0085324!16s%2Fg%2F1tznnlzk?entry=ttu">Ubicación</a></li>
        <li><a href="">No se reserva</a></li>
